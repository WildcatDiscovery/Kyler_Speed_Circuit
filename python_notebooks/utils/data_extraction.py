#EXPEDITES THE PROCESS OF IMPORTING THE DATA IN THE FORM OF AN MPT FILE
#WILL BE ADDING HOW TO PROCESS NDR FILES AS WELL AS ONLY BATCHES OF MPT FILES CAN BE EXPORTED 
#EC LAB SOFTWARE
